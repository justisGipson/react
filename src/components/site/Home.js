            ...
            <div className="main">
                <div className="mainDiv">
                    ...
                    <ul>
                        ...
                        <li>We have tried to collect the very best resources for this app, and we have cited those to <Link to="/resources">here</Link>.</li>
